...
- What, in your opinion, is an important part of code reviews? That is, what is
  ...
  when others do the same for your code?
    ...
    - I love functionalization. The obvious benefit is reusability, but the 
      reason I love it is because it gives you opportunities for abstraction,
      which makes code far easier to reason about. Complex things aren't built
      in one shot, or if they are they generally suffer for it. Complex things
      are built from lots of simpler things operating together, and functions
      give you the ability to give a name to a certain code block and simply
      reason about its inputs and outputs, rather than worrying about the whole
...
- We have an awful lot of computers here, and it gets pretty confusing with
  ...
  improve this situation?
    ...
    - Containers help because they effectively allow you to reproduce machine
      states. We might have drastically different hardware, but if we're both
      initializing containers from the same image, we can rest assured that if
      we get different results on each of our containers, the problem has to do
      with the code we're running and not differences in machine state.
